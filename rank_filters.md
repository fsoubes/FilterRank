...
Then, we invert the image, run it through our maximum filter, and invert the result. To ensure that the inverted image fits into our data range,we use the following conversion instead:


where I0 is the maximum value in our data range.
