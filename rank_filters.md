...
![Property of the maximun operator](https://github.com/fsoubes/FilterRank/edit/rank_filters-min-maxversion/rank_filters.md/formule1.png)

The same applies to the minimum operator: 
![Property of the min operator](formule2.png)
...
![Formula of the conversion between max I and min I](Sans titremin1.png)
