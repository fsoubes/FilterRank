...
![Property of the maximun operator](Sans titremin1.png)

The same applies to the minimum operator: 
![Property of the min operator](Sans titremin2.png)
...
![Formula of the conversion between max I and min I](formule1.png )
