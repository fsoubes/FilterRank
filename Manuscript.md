...
The median filter has been suggested by Tukey[2]. Firstly naiv the algorithm was then improved based on the moving histogram technique[3]. In discrete mathematical morphology, the minimum and maximum ranks play a key role since they correspond to the fundamental erosion and dilation operators[1].
