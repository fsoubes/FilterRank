...
However for the 16 bit, we werent able to find a solution to find a treshold that's fit to display the image with variance filter probably due to the the texture gl.REDUI16
