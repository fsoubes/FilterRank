...
The main issue here was to pass those values that are between 0 and 1 because of the fragment shader treat only values in a set of range between [0..1] as said earlier and not  between [0 ... 2N - 1]. For an 8 bit image we multiply the pixels containing in the output color by 255. 
