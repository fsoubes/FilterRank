...
let workflow = cpu.pipe(variance(kernel),cpu.view);
let view2 = workflow(img2.getRaster());
let crop8 = cpu.pipe(cpu.crop(1,2,view2.width - kernel_size, view2.height - kernel_size), cpu.view);
...
let workflow1 = cpu.pipe(variance(kernel),cpu.view);
let view02 = workflow1(img02.getRaster());
let cropp16 = cpu.pipe(cpu.crop(1,2,view02.width - kernel_size, view02.height - kernel_size), cpu.view);
...
let view001 = cpu.view(img001.getRaster());
...
let workflow2 = cpu.pipe(variance(kernel),cpu.view);
